...
def write_enum_data_cpp(minions, heroes):
    with open("src/utils/enum_data.cpp", "wt", encoding="utf-8") as f:
        f.write("#include \"enums.h\"\n")
        # qwer
        # f.write("#include \"random_keys.h\"\n")
        f.write("#include \"MinionInfo.h\"\n\n")
        f.write("// -----------------------------------------------------------------------------\n")
        f.write("// THIS FILE IS AUTOGENERATED\n")
        f.write("// see generate_enum_data.py\n")
        f.write("// -----------------------------------------------------------------------------\n\n")
        ...
        f.write("// -----------------------------------------------------------------------------\n\n")
        f.write("const char* gTribeNames[] = {\n")
        for i in sorted(tribes):
        ...
        f.write("// -----------------------------------------------------------------------------\n\n")
        f.write("const MinionInfo gMinionInfo[] = {\n")
        for m in minions:
            e = m[0]
            f.write("    {{{}, {{{}, {}}}, {}, Tribe::{}, {}, {}, {}, {}, {}, {}, {}, {}, {}}},\n".format(
        ...
        f.write("// -----------------------------------------------------------------------------\n\n")
        f.write("const HeroInfo gHeroInfo[] = {\n")
        for e in heroes:
            hp = e.hp
